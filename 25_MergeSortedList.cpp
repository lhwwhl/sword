...
ListNode* MergeLoop(ListNode *pHead1, ListNode *pHead2) {
    if(pHead1 == nullptr)
        return pHead2;
    if(pHead2 == nullptr)
        return pHead1;
    ...
    pNode->m_pNext = pHead1 ? pHead1 : pHead2;
...
ListNode* Test(char* testName, ListNode* pHead1, ListNode* pHead2)
{
    ...
    ListNode* pMergedHead = MergeLoop(pHead1, pHead2);
